...
class argument_class(object):
    def __init__(self):
        self.env_name = 'RobInvertPendulum'
        self.num_episodes = int(150)
        self.seed = 1
        self.num_steps = 500
...
while iteration_counter < args.num_episodes:
    ...
    if var >= 0.05 and (ep_type_number % 4 == 0):
    ...
    if ep_type_number == 0:
        ...
        if training_flag and iteration_counter < 70:
